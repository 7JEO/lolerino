...
public:
    ...
    BoolSetting legacyDankerinoGrayOutRecents = {
        "/appearance/messages/gratOutRecents", true};
    ...
    BoolSetting animateSevenTVBadges = {"/appearance/messages/animateSevenTVBadges", true};
    ...
    BoolSetting allowAvifImages = {"/appearance/messages/allowAvifImages", false};
    /// Links
    ...
    BoolSetting showUserRoles = {"/misc/userRoles", false};
